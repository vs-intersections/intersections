...
const SidebarMobile = ({ data }) => {
  ...
  return (
    ...
    <div className="pt-4 px-4 bg-gray-100 relative overflow-y-auto scrollbar-thin scrollbar-thumb-black scrollbar-track-gray-300 overflow-x-hidden transform">
